...
def to_auto(cls, scenery: Scenery, identifier=None, parent_identifier=None):
    ...
    # Type
    # TODO Simplified AUTO does not have signs (yet) - we shall at least re-add those present in the OMEGA format
    if not _IS_AUTO_SIMPLIFIED:
